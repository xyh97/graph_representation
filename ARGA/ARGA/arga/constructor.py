...
def format_data(data_name):
    ...
    adj, features, y_train, y_test, tx, ty, train_mask, test_mask, true_labels = load_data(data_name)
    ...
    items = [adj, num_features, num_nodes, features_nonzero, pos_weight, norm, adj_norm, adj_label, features, true_labels, train_edges, val_edges, val_edges_false, test_edges, test_edges_false, adj_orig, test_mask, y_train, y_test, train_mask]
    feas = {}
    for item in items:
